...
public class LikeableMemberGetterFactory {
    ...
    private final Map<MemberType, LikeableMemberService<? extends LikeableMember>> map;
    ...
    public LikeableMemberGetterFactory(@Autowired List<LikeableMemberService<? extends LikeableMember>> likeableMemberServices) {
        map = likeableMemberServices.stream()
            .collect(Collectors.toConcurrentMap(
                ...
                LikeableMemberService::getLikeableMemberService));
    }

    public LikeableMemberService<? extends LikeableMember> get(MemberType memberType) {

...
public class LikeServiceFactory {
    ...
    public LikeServiceFactory(@Autowired List<LikeService<? extends Like<? extends LikeableMember>>> likeServices) {
        map = likeServices.stream()
            .collect(Collectors.toConcurrentMap(
                LikeService::getTargetLikeableMemberType,
                Function.identity()));
    }

    public LikeService<? extends Like<? extends LikeableMember>> getLikeService(MemberType targetLikeableMemberType) {

...
public class EventData {
    ...
    public static class R {
        ...
        public static class event1 {
            ...
            public static final String thumbnailUrl = ImageData.getThumbnailUrl(_Relation.images().getFirst());
    ...
    public static class event1 {
            ...
            public static class create {
                public static EventCreateRequest get() {
                    return EventCreateRequest.builder()
                        ...
                        .totalSeat(R.event1.totalSeat)
                        .category(R.event1.category)
                        .imageIds(R.event1._Relation.images().stream().map(EventImage::getId).toList())
                        .build();
                }
            }
        ...
        public static class response {
            public static EventResponse get() {
                return EventResponse.from(EventData.event1.entity.get(), R.event1._Relation.imageUrls());
            }
        }
    }
